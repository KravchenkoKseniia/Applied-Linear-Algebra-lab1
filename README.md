...
- Коли модуль визначника дорівнює 0. Враховуючи той факт, що коли модуль визначника - 0, то це є ознакою виродженності матриці, що, у свою чергу, є ознакою лінійної залежності. З цього, сподіваюсь, можна зробити висновок, що простір при даній трансформації стає меншої розмірності: вектори, що були лінійно незалежними стають лінійно залежними.
